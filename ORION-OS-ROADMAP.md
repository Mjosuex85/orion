...
**The two layers:**
```
System layer   → workflows, skills, templates, decisions (reusable, generic)
Instance layer → projects/<n>.md, logs, personal decisions (private, per user)
```

---

## CURRENT STATE — v1.5.0 (April 15, 2026)
...
### v2.0.0 — orion-os public repo
```
Goal: clean fork of the system layer, no project data, anyone can clone and use
What changes:
  - New repo: Mjosuex85/orion-os (public)
  - Contains: workflows/, skills/, templates/, agents/ (generic), ORION.md (generic)
  - Does NOT contain: projects/, logs/, personal decisions
  - README explains how to create your own orion instance
  - Mario's instance (Mjosuex85/orion) remains private
```
...
3. How does orion-os (public) stay in sync with Mario's private instance?
   → Manual cherry-pick? GitHub Actions? Subtree?
...
- Make architectural decisions about v2.0.0 and v3.0.0
