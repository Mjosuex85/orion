...
> Business vision and ideas live in `projects/gameon/gameon-ideas.md`.
> Project-specific decisions live in `projects/gameon/gameon-decisions.md`.
> Architecture reference live in `projects/gameon/gameon-architecture.md`.
...
*Ideas and product roadmap → `projects/gameon/gameon-ideas.md`*
